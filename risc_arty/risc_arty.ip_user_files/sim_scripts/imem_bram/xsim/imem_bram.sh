...
#
# Script generated by Vivado on Fri Jan 17 01:34:06 +0100 2025
# SW Build 5164865 on Thu Sep  5 14:37:11 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : imem_bram.sh
...
#
# Usage        : imem_bram.sh
#                imem_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                imem_bram.sh [-reset_run]
#                imem_bram.sh [-reset_log]
#                imem_bram.sh [-help]
#
...
# script info
echo -e "imem_bram.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./imem_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot imem_bram xil_defaultlib.imem_bram -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim imem_bram -key {Behavioral:sim_1:Functional:imem_bram} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Xinlix/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb imem_bram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./imem_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: imem_bram.sh [-help]\n\
Usage: imem_bram.sh [-step]\n\
Usage: imem_bram.sh [-lib_map_path]\n\
Usage: imem_bram.sh [-reset_run]\n\
Usage: imem_bram.sh [-reset_log]\n\
Usage: imem_bram.sh [-keep_index]\n\
Usage: imem_bram.sh [-noclean_files]\n\n\
