...
#
# Script generated by Vivado on Thu Jan 16 20:18:59 +0100 2025
# SW Build 5164865 on Thu Sep  5 14:37:11 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dmem_bram.sh
...
#
# Usage        : dmem_bram.sh
#                dmem_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dmem_bram.sh [-reset_run]
#                dmem_bram.sh [-reset_log]
#                dmem_bram.sh [-help]
#
...
#                script (type 'dmem_bram.sh -help' for more information).
#
...
# script info
echo -e "dmem_bram.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dmem_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dmem_bram xil_defaultlib.glbl -o dmem_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dmem_bram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dmem_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dmem_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dmem_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dmem_bram.sh [-help]\n\
Usage: dmem_bram.sh [-step]\n\
Usage: dmem_bram.sh [-lib_map_path]\n\
Usage: dmem_bram.sh [-reset_run]\n\
Usage: dmem_bram.sh [-reset_log]\n\
Usage: dmem_bram.sh [-keep_index]\n\
Usage: dmem_bram.sh [-noclean_files]\n\n\
