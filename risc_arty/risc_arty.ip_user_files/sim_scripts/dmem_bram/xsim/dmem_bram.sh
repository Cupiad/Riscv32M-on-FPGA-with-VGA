...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot dmem_bram xil_defaultlib.dmem_bram -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dmem_bram -key {Behavioral:sim_1:Functional:dmem_bram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dmem_bram.wdb xsim.dir libdpi.so)
